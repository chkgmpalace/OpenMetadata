...
if os.environ.get('AIRFLOW__CORE__DAGS_FOLDER_OMD') is not None:
    AIRFLOW_DAGS_FOLDER_OMD = os.environ['AIRFLOW__CORE__DAGS_FOLDER_OMD']
else:
    AIRFLOW_DAGS_FOLDER_OMD = conf.get("core","DAGS_FOLDER")
